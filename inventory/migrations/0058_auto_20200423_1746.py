...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('inventory', '0057_auto_20200421_1322'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='vehicle_type',
            field=models.CharField(choices=[('HA', 'Hatchback'), ('SA', 'Saloon'), ('ES', 'Estate'), ('MP', 'MPV'), ('SU', 'SUV'), ('CO', 'Coupe'), ('SP', 'Sports Car'), ('CN', 'Convertible'), ('VA', 'Van')], max_length=2),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='vehicleownership',
            name='date_created',
            field=models.DateTimeField(default=datetime.datetime(2020, 4, 23, 17, 46, 23, 994849)),
        ),
    ]
