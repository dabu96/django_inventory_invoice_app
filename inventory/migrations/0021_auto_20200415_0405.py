...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('inventory', '0020_auto_20200413_2023'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='vehicleownership',
            name='date_created',
            field=models.DateTimeField(default=datetime.datetime(2020, 4, 15, 4, 5, 52, 262412)),
        ),
        migrations.CreateModel(
            name='PartImage',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('img', models.ImageField(blank=True, null=True, upload_to='images/parts/')),
